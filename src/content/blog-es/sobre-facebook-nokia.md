...
Si la viviste recordarás las malas artes de las que se valieron ambos protagonistas (**\</marquee\>**, **\</blink\>**, **\</frame\>** y demás atrocidades) y los daños colaterales que supuso (webs ~~sólo compatibles~~ optimizadas para IE/Netscape o el ["descanso" de 5 años](http://meyerweb.com/eric/browsers/timeline-structured.html) en el desarrollo de Internet Explorer). En resumen, el "todo vale" de cara a monopolizar el mercado y el posterior freno a la innovación que conlleva.
...
- **Facebook**: te ofrezco [mi API](http://wiki.developers.facebook.com/index.php/API), pero programas en [mi lenguaje](http://wiki.developers.facebook.com/index.php/FBML), los usuarios son míos y las aplicaciones que desarrolles no salen de mi casa. Ah y, se me olvidaba, por supuesto [la publi la controlo yo](http://www.facebook.com/business/?socialads).
- **Google**: te ofrezco mi API ([OpenSocial](http://code.google.com/apis/opensocial/)), programas en lenguajes estándar, los usuarios los pones tú y te llevas tu aplicación donde te de la gana. Pero eso sí, el resto (incluida la publicidad) lo controlo yo.
- **Facebook**: Busco [alianzas](http://www.error500.net/facebook-alianza-nokia) para incluir mi red social en todo tipo de plataformas y así asegurar su liderazgo.
- **Google**: Creo plataformas ([Android](http://code.google.com/android/), OpenSocial) a la que todo tipo de redes sociales están invitadas, las dejo que se peleen por su trocito del pastel **mientras yo me convierto en la plataforma universal**.
