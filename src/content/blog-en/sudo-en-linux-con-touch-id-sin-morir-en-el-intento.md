...
![Flow diagram](/blog/sudo-en-linux-con-touch-id-sin-morir-en-el-intento/flow-diagram.png)

---

## 1. Enable the SSH agent in 1Password

![1Password Agent settings](/blog/sudo-en-linux-con-touch-id-sin-morir-en-el-intento/1password-agent.png)
